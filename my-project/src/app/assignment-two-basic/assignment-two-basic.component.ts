...
@Component({
  selector: 'app-assignment-two-basic',
  templateUrl: './assignment-two-basic.component.html',
  styleUrls: ['./assignment-two-basic.component.css']
})
export class AssignmentTwoBasicComponent {
